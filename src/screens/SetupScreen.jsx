...
export function SetupScreen({ onStart, onBack, isLandscape }) {
  ...
  return (
    <div
      className="flex flex-col min-h-[100dvh] bg-goscore-bg overflow-hidden md:items-center md:justify-center"
      style={{
    ...
    >
      <div className="flex flex-col flex-1 w-full max-w-lg md:max-w-xl md:flex-initial md:min-h-[480px] md:max-h-[680px] mx-auto">
        <header
